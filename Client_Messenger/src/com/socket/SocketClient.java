    ...
    public void run() {
        ...
        while(keepRunning){
            try {
                ...
                //if the client enters some message it checks and prints the content
                ...
                //If the user logins its display the message 
                ...
                //When a user clicks the connect button it connects to the server 
                ...
                //If any new user sign's up with new username and password
                    ...
                    //dialog box appears when the user sends any file to anyother clients 
                    if(JOptionPane.showConfirmDialog(ui, ("Accept '"+msg.content+"' from "+msg.sender+" ?")) == 0){
                        //selects the file which the user wants to send
